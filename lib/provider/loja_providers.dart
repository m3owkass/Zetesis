...
final itemsProvider = StreamProvider.autoDispose<List<ItemLojaModel>>((ref) {
  return ref.read(itemLojaRepositoryProvider).watchAll();
});

const kNomeItemTemaEscuro = 'Tema Escuro';

final possuiTemaEscuroProvider = Provider.autoDispose<bool>((ref) {
...
final modoEscuroAtivoProvider = Provider.autoDispose<bool>((ref) {
  final user = ref.watch(userProvider).value;
